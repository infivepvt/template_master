...
<body>
    ...
    <div class="profile-card">
        <div class="profile-banner">
            <div class="imagepro">
                <img class="profile-photo" src="profile_img/main_profile/template4-p.png" alt="Profile">
            </div>
            <div class="profile-info">
                <h2 style="font-family: Verdana, sans-serif;">Lucille R. Grondin</h2>
        ...
        <div class="profile-contact-icons">
            ...
            <button class="icon-button" onclick="window.open('tel:0761231212', '_self')">
                <i class="fas fa-phone"></i>
            </button>
            <button class="icon-button" onclick="window.open('https://www.facebook.com', '_blank')">
                <i class="fab fa-facebook"></i>
            </button>
            <button class="icon-button" onclick="window.open('https://wa.me/94761231212', '_blank')">
...
END:VCARD`;
      ...
      a.href = url;
      a.download = 'Lucille_Grondin.vcf';
