...
<head>
    ...
    <style>
        ...
        .header-banner {
            height: 250px; 
            background-image: url('banner_img/main_banner/template37-b.jpg'); 
    ...
    <div class="digital-card-container">
        ...
        <div class="elementor-widget-wrap elementor-element-populated">
            <div class="elementor-element elementor-element-3c5b664 elementor-widget elementor-widget-image" data-id="3c5b664" data-element_type="widget" data-settings="{&quot;_animation_mobile&quot;:&quot;fadeInDown&quot;}" data-widget_type="image.default">
                <div class="elementor-widget-container">
                    <img decoding="async" src="profile_img\main_profile\template37-p.png" title="portrai6" alt="portrai6" loading="lazy">
                </div>
            </div>
            <div class="elementor-element elementor-element-e304601 elementor-widget elementor-widget-heading" data-id="e304601" data-element_type="widget" data-settings="{&quot;_animation_mobile&quot;:&quot;fadeInLeft&quot;}" data-widget_type="heading.default">
                <div class="elementor-widget-container">
                    <h2 class="elementor-heading-title elementor-size-default">Jennifer Lim</h2>
                </div>
            </div>
            <div class="elementor-element elementor-element-cd32f18 elementor-widget elementor-widget-text-editor" data-id="cd32f18" data-element_type="widget" data-settings="{&quot;_animation_mobile&quot;:&quot;fadeInLeft&quot;}" data-widget_type="text-editor.default">
                <div class="elementor-widget-container">
                    <p style="text-align: center;">Business Development Director</p>
                </div>
            </div>
                                ...
                                <div class="elementor-widget-container">
                                    <div class="elementor-social-icons-wrapper elementor-grid">
                                        <span class="elementor-grid-item">
                                            <a class="elementor-icon elementor-social-icon elementor-social-icon-phone-alt elementor-repeater-item-13c7ba5" target="_blank" onclick="window.open('tel:{{YOUR_PHONE_NUMBER}}', '_self')">
                        ...
                        <div class="elementor-widget-wrap elementor-element-populated">
                            <div class="elementor-element elementor-element-234abfb elementor-shape-rounded elementor-grid-0 e-grid-align-center elementor-widget elementor-widget-social-icons" data-id="234abfb" data-element_type="widget" data-widget_type="social-icons.default">
                                <div class="elementor-widget-container">
                                    <div class="elementor-social-icons-wrapper elementor-grid">
                                        <span class="elementor-grid-item">
                                            <a class="elementor-icon elementor-social-icon elementor-social-icon-whatsapp elementor-repeater-item-13c7ba5" target="_blank" href="https://wa.me/{{YOUR_WHATSAPP_NUMBER}}" rel="noopener noreferrer">
                        ...
                        <div class="elementor-widget-wrap elementor-element-populated">
                            <div class="elementor-element elementor-element-6aa98c0 elementor-shape-rounded elementor-grid-0 e-grid-align-center elementor-widget elementor-widget-social-icons" data-id="6aa98c0" data-element_type="widget" data-widget_type="social-icons.default">
                                <div class="elementor-widget-container">
                                    <div class="elementor-social-icons-wrapper elementor-grid">
                                        <span class="elementor-grid-item">
                                            <a class="elementor-icon elementor-social-icon elementor-social-icon-envelope elementor-repeater-item-13c7ba5" target="_blank" onclick="window.open('mailto:{{YOUR_EMAIL_ADDRESS}}', '_self')">
                        ...
                        <div class="elementor-widget-wrap elementor-element-populated">
                            <div class="elementor-element elementor-element-a058820 elementor-shape-rounded elementor-grid-0 e-grid-align-center elementor-widget elementor-widget-social-icons" data-id="a058820" data-element_type="widget" data-widget_type="social-icons.default">
                                <div class="elementor-widget-container">
                                    <div class="elementor-social-icons-wrapper elementor-grid">
                                        <span class="elementor-grid-item">
                                            <a class="elementor-icon elementor-social-icon elementor-social-icon-location-arrow elementor-repeater-item-13c7ba5" target="_blank" href="{{YOUR_LOCATION_MAP_URL}}" rel="noopener noreferrer">
        ...
        <div class="card-footer-info">
            <div class="elementor-element elementor-element-cadbdd6 elementor-widget elementor-widget-heading" data-id="cadbdd6" data-element_type="widget" data-settings="{&quot;_animation_mobile&quot;:&quot;fadeInDown&quot;}" data-widget_type="heading.default">
                <div class="elementor-widget-container">
                    <h2 class="elementor-heading-title elementor-size-default">AB Jewellers</h2>
                </div>
            </div>
            <div class="elementor-element elementor-element-0133341 elementor-widget elementor-widget-text-editor" data-id="0133341" data-element_type="widget" data-settings="{&quot;_animation_mobile&quot;:&quot;fadeInDown&quot;}" data-widget_type="text-editor.default">
                <div class="elementor-widget-container">
                    <p style="text-align: center;">Street Number, Street Name,<br>Town, Postal Code,<br>State, province, Country</p>
                </div>
            </div>
        </div>
        </div>
    ...
    <script>
        function generateVCF() {
            const contactData = {
                ...
                company: "AB Jewellers",
                phoneWork: "+6512345678", // Replace with actual phone number (e.g., +1234567890)
                email: "jennifer.lim@example.com", // Replace with actual email
                website: "https://www.abjewellers.com", // Replace with actual website
                address: "Street Number, Street Name, Town, Postal Code, State, Province, Country", // Replace with actual address
                profileImage: "https://vcode.pro/wp-content/uploads/elementor/thumbs/portrai6-qhgwzwggjp7ez09v3ie06aacbbkzqirjnl1pb38s8w.png",
            };
