    ...
    <div class="card-container14 text-center">
        ...
        <div class="profile-header14">
            ...
            <div class="profile-header14 mt-3">
                <img src="profile_img/main_profile/template13-p.png" alt="Profile Image" class="rounded-circle" />
            </div>
            <h2 class="profile-name">Luna Charlotte</h2>
            <p class="job-title">Owner/CEO</p>
        ...
        <div class="profile-contact-icons21">
            ...
            <button type="button" onclick="window.open('https://maps.google.com/?q=Address+Here', '_blank')">
                <i class="fas fa-map-marker-alt me-2"></i>
                <span>919 Oaktree Crescent, Newmarket</span>
            </button>
