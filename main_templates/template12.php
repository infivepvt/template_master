    ...
    <div class="d-flex justify-content-center mt-5">
        <div class="card custom-card75 shadow-lg" style="background-color: #00114b;">
            <div class="card-header custom-header text-center"
                style="background-image: url('banner_img/main_banner/template12-b.jpg'); height: 100%; opacity: 1;">
                ...
                <div class="profile-picture75">
                    <img src="profile_img/main_profile/template12-p.png" alt="Peter Smith" class="rounded-circle">
                </div>
            </div>
            <br><br>
            ...
            <div class="card-body text-left" style="background-color: #00114b; color: #000000;">
                <h2 class="card-title" style="font-size: 30px;color:rgb(255, 255, 255);">Peter Smith</h2>
                <p style="color:rgb(255, 255, 255); font-size: 20px;">luxury Real Estate/Upgrade Specialist</p>
