    ...
    <div class="d-flex justify-content-center mt-5">
        <div class="card custom-card shadow-lg" style="background-color: #FFFFFF;">
            ...
            <div class="card-body text-center"
                ...
                <h2 class="card-title" style="font-size: 27px; text-transform: uppercase;">William James</h2>
                <p style="color: #000000; font-size: 21px; text-transform: uppercase;">realtor</p>
