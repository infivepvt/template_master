...
<body>
        ...
        <div class="card custom-card shadow-lg" style="background-color: #FFFFFF;">
            <div class="card-header custom-header text-center"
                ...
                <div class="profile-picture">
                    <img src="profile_img/client_profile/sonali-p.jpeg" alt="Saliya Pathum" class="rounded-circle">
                </div>
            </div>
            <br><br>
            <div class="card-body text-center"
                style="background-color: #FFFFFF; color: #504192; text-decoration: none; margin-top:50px;">
                <h2 class="card-title" style="font-size: 27px; text-transform: uppercase;">Sonali Fernando</h2>
                <p style="color: #504192; font-size: 21px; text-transform: uppercase;">Director <br> Business
                    Development</p>

                <a href="https://wa.me/+94763610001" target="_blank" rel="noopener noreferrer"
                ...
                <div class="list-group mb-3">
                    <button type="button"
                        ...
                        onclick="window.open('tel:+94763610001', '_self')">
                        <img src="Images/icon/phone.png" alt="" style="width: 30px; height: 30px; margin-right:25px;">
                        <span class="text-center flex-grow-1 text-truncate custom-phone"
                            style="color: #FFFFFF; font-family: 'Montserrat', sans-serif;">+94 763 610 001</span>
                    </button>
                    <button type="button"
                        class="list-group-item d-flex align-items-center justify-content-between contact"
                        onclick="window.open('mailto:sonali@sjhospital.lk', '_self')">
                        <img src="Images/icon/mail.png" alt="" style="width: 30px; height: 30px; margin-right:25px;">
                        <span class="text-center flex-grow-1 text-truncate custom-phone"
                            style="color: #FFFFFF; font-family: 'Montserrat', sans-serif; font-size:16px;">sonali@sjhospital.lk</span>
                    </button>
                    <button type="button"
                        class="list-group-item d-flex align-items-center justify-content-between contact"
    ...
    <script>
        function shareQR() {
            const qrCodeUrl = 'https://tapilinq.com/sonali';

            if (navigator.share) {
                navigator.share({
                    title: 'Scan to save contact',
                    text: 'Scan this QR code to save Sonali Fernando\'s contact information',
                    url: qrCodeUrl
                })
                    .catch(error => console.log('Error sharing:', error));
            } else {
                const shareUrl = `whatsapp://send?text=Scan this QR code to save Sonali Fernando's contact information: ${qrCodeUrl}`;
