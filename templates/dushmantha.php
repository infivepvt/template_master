    ...
    <div class="d-flex justify-content-center mt-5">
        <div class="card custom-card shadow-lg" style="background-color: #FFFFFF;">
            <div class="card-header custom-header text-center"
                style="background-image:  url('banner_img/client_banner/dushmantha-b.png?odf'); height: 230px; opacity: 1;">
                <img src="logo_img/client_logo/dushmantha-l.png" alt="Company Logo" class="custom-logo" height="80px"
                    style="width: 150px; height: 150px; opacity: 1; margin-top:-30px;">
                <div class="profile-picture">
                    <img src="profile_img/main_profile/Main_Design-p.png" alt="Saliya Pathum" class="rounded-circle">
                </div>
            </div>
            <br>
            <br>
            <div class="card-body text-center"
                ...
                <h2 class="card-title" style="font-size: 27px; text-transform: uppercase;">Charith Dushmantha</h2>
                <p style="color: #000000; font-size: 21px; text-transform: uppercase;">Owner</p>
