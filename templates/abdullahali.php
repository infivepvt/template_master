...
<head>
    ...
    <style>
        .custom-card {
            border-radius: 15px;
            overflow: hidden;
            background-image: url("banner_img/client_banner/abdullahali-b1.png");
            width: 450px;
            height: auto;
            margin-top: -55px;
        }
    ...
    <div class="d-flex justify-content-center mt-5">
        <div class="card custom-card shadow-lg" style="background-color: #FFFFFF;">
            <div class="card-header custom-header text-center"
                style="background-image:  url('banner_img/client_banner/abdullahali-b.jpg'); height: 200px; opacity: 1;">
            ...
            <div class="card-body text-center">
                ...
                <p class="fw" style="font-family: 'Montserrat', sans-serif; font-size:19px; color:rgb(255, 255, 255);">CONNECT WITH SOCIAL MEDIA
                </p>
