...
<head>
    ...
    <title>Lokesh - CEO of Cradlewell</title>
    ...
    <div class="card custom-card shadow-lg">
        <div class="card-header custom-header text-center">
            ...
            <div class="headshot-container">
                <img src="profile_img/client_profile/cradlewell-p.png" alt="Lokesh - CEO" class="headshot">
            </div>
        </div>

        <div class="card-body text-center">
            <h2 class="card-title">Lokesh</h2>
            <p class="card-subtitle">Chief Executive Officer</p>

            <a href="tel:+918826006537" style="text-decoration: none;">
                <button class="btn w-100 contact-button">
                    <div class="button-content d-inline-flex align-items-center justify-content-center gap-2">
                        ...
                        <span class="button-text">+91 8826006537</span>
                    </div>
                </button>
            </a>

            <div class="list-group mb-3">
                <div class="list-group-item" onclick="window.open('mailto:lokesh@cradlewell.com', '_self')">
                    <div class="contact-icon">
                        <i class="fas fa-envelope"></i>
                    </div>
                    <div class="contact-text">lokesh@cradlewell.com</div>
                </div>
                ...
                <div class="list-group-item" onclick="window.open('tel:+919363893639', '_self')">
                    ...
                    <div class="contact-text">+91 9363893639 (General Inquiries)</div>
                </div>
