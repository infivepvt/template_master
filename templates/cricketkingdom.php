        ...
        <div class="card custom-card75 shadow-lg" style="background-color: #00114b;">
            <div class="card-header custom-header text-center"
                ...
                <div class="profile-picture75">
                    <img src="profile_img/client_profile/cricketkingdom-p.png" alt="Peter Smith" class="rounded-circle">
                </div>
            </div>
            <br><br>
            ...
            <div class="card-body text-left" style="background-color: #00114b; color: #000000;">
                <h2 class="card-title" style="font-size: 30px;color:rgb(255, 255, 255);">Athif Fauzdeen</h2>
                <p style="color:rgb(255, 255, 255); font-size: 20px;">CEO <br>Importer and Distributor of Cricket Goods</p>
                
                <a href="https://wa.me/94779288666" target="_blank" rel="noopener noreferrer"
                ...
                <div class="list-group mb-3">
                    <button type="button"
                        ...
                        onclick="window.open('tel:0779288666', '_self')">
                        <img src="Images/icon/phone.png" alt="" style="width: 30px; height: 30px; margin-right:25px;">
                        <span class="text-center flex-grow-1 text-truncate custom-phone"
                            style="color: #FFFFFF; font-family: 'Montserrat', sans-serif;">+94 779 288 666</span>
                    </button>

                    <button type="button"
                        class="list-group-item d-flex align-items-center justify-content-between contact"
                        onclick="window.open('mailto:athiffcav@gmail.com', '_self')">
                        <img src="Images/icon/mail.png" alt="" style="width: 30px; height: 30px; margin-right:25px;">
                        <span class="text-center flex-grow-1 text-truncate custom-phone"
                            style="color: #FFFFFF; font-family: 'Montserrat', sans-serif; font-size:16px;">athiffcav@gmail.com</span>
                    </button>
                    ...
                    <button type="button"
                        ...
                        <span class="text-center flex-grow-1 text-truncate custom-phone"
                            style="color: #FFFFFF; font-family: 'Montserrat', sans-serif; font-size:16px;">296/6 Bulugohotenna Akurana</span>
                    </button>
                </div>
...
VERSION:3.0
FN:Peter Smith
TITLE:Luxury Real Estate/Upgrade Specialist
TEL;TYPE=WORK,VOICE:0761231212
EMAIL:youremail@yourwebsite.com
URL:www.yourwebsiteaddress.com
