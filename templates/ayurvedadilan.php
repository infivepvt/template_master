...
<body>
  ...
  <div class="name-section">
    <h4 style="color:#5b0e2e;font-weight :bold">Mr.Dilan Nanayakkara</h4>
    <div class="divider"></div>
    <p class="text-muted">Assistant Sales Manager</p>
    <p class="small-text">
  ...
  <div class="container my-4">
    <div class="row text-center contact-box mx-1 justify-content-center">
      <div class="col-4 mb-3" onclick="window.open('tel:0716275014 ', '_self')">
      ...
      <div class="col-4 mb-3" onclick="window.open('https://wa.me/94716275014 ', '_blank')">
        <i class="fab fa-whatsapp contact-icon"></i><br />
        <span>Whatsapp</span>
      </div>
      <div class="col-4 mb-3" onclick="window.open('mailto:dilan@adhitya.lk', '_self')">
...
async function generateVCF() {
  ...
  const contactData = {
    ...
    phoneMobile: "+94716275014", // Standardized with country code
    phoneWork: "+94252030200",  // Standardized with country code
    email: "dilan@adhitya.lk",
  ...
  try {
    ...
    // Create VCF content with base64 image (excluding logo)
