    ...
    <div class="d-flex justify-content-center mt-5">
        <div class="card custom-card shadow-lg" style="background-color: #FFFFFF;">
            <div class="card-header custom-header text-center"
                style="background-image:  url('banner_img/client_banner/manoj-b.jpeg'); height: 200px; opacity: 1;">
            ...
            <div class="card-body text-center"
                ...
                <h2 class="card-title" style="font-size: 27px; text-transform: uppercase;">Manoj Fernando</h2>
                <p style="color: #000000; font-size: 21px; text-transform: uppercase;">Director Tuk Tuk Rental Negombo (Pvt)Ltd</p>

                <a href="https://wa.me/+94702424558" target="_blank" rel="noopener noreferrer"
                ...
                <div class="list-group mb-3">
                    <button type="button"
                        ...
                        onclick="window.open('tel:+94702424558', '_self')">
                        <img src="Images/icon/phone.png" alt="" style="width: 30px; height: 30px; margin-right:25px;">
                        <span class="text-center flex-grow-1 text-truncate custom-phone"
                            style="color: #FFFFFF; font-family: 'Montserrat', sans-serif;"> +94 70 242 4558 </span>
                    </button>

                    <button type="button"
                        class="list-group-item d-flex align-items-center justify-content-between contact"
                        onclick="window.open('mailto:wmanojfernando@gmail.com', '_self')">
                        <img src="Images/icon/mail.png" alt="" style="width: 30px; height: 30px; margin-right:25px;">
                        <span class="text-center flex-grow-1 text-truncate custom-phone"
                            style="color: #FFFFFF; font-family: 'Montserrat', sans-serif; font-size:16px;">wmanojfernando@gmail.com</span>
                    </button>
                    ...
                    <button type="button"
                        ...
                        <span class="text-center flex-grow-1 text-truncate custom-phone"
                            style="color: #FFFFFF; font-family: 'Montserrat', sans-serif; font-size:16px;">40/ A, Lewis Place, Sea Street, Negombo.</span>
                    </button>
                </div>
                <!--
    ...
    <script>
        function generateVCF() {
            ...
            const contactData = {
                firstName: "Manoj",
                lastName: "Fernando",
                title: "Director Tuk Tuk Rental Negombo (Pvt)Ltd",
                phoneWork: "+94702424558",
                phoneMobile: "",
                email: "wmanojfernando@gmail.com",
                email2: "",
                email3: "",
                website: "tuktukrentalnegombo.com",
                website2: "",
                website3: "",
                address: "40/ A, Lewis Place, Sea Street, Negombo.",
                address2: "",
                about: "",
                logo: "profile_img/client_profile/manoj-p.jpg",
                profileImage: "profile_img/client_profile/manoj-p.jpg"
            };
