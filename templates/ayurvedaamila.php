...
<body>
  ...
  <div class="name-section">
    <h4 style="color:#5b0e2e;font-weight :bold">Mr.Amila Herath </h4>
  ...
  <div class="container my-4">
    <div class="row text-center contact-box mx-1 justify-content-center">
      <div class="col-4 mb-3" onclick="window.open('tel:0704725631', '_self')">
      ...
      <div class="col-4 mb-3" onclick="window.open('https://wa.me/94704725631', '_blank')">
        <i class="fab fa-whatsapp contact-icon"></i><br />
        <span>Whatsapp</span>
      </div>
      <div class="col-4 mb-3" onclick="window.open('mailto:amila@adhitya.lk', '_self')">
...
<script>
  async function generateVCF() {
    // Updated contact information for Mr. Amila Herath
    const contactData = {
      firstName: "Amila",
      lastName: "Herath",
      title: "Senior Manager",
      phoneWork: "0252030200",
      phoneMobile: "0704725631",
      email: "amila@adhitya.lk",
