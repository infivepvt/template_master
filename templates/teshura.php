    ...
    <div class="d-flex justify-content-center mt-5">
        <div class="card custom-card shadow-lg" style="background-color: #FFFFFF;">
            <div class="card-header custom-header text-center"
                style="background-image:  url('banner_img/client_banner/Teshura-b.jpg'); height: 200px; opacity: 1;">
                ...
                <div class="profile-picture">
                    <img src="profile_img/client_profile/Teshura-p.png" alt="Saliya Pathum" class="rounded-circle">
                </div>
            </div>
            <br>
            <br>
            <div class="card-body text-center"
                ...
                <h2 class="card-title" style="font-size: 27px; text-transform: uppercase;">Teshura Wallace</h2> 
                <h2 class="card-title" style="font-size: 15px; text-transform: uppercase;">Wally’s Convenience Store</h2>
                <p style="color: #000000; font-size: 13px; text-transform: uppercase;">Owner</p>
                ...
                <div class="list-group mb-3">
                    ...
                    <button type="button"
                        ...
                        <span class="text-center flex-grow-1 text-truncate custom-phone"
                            style="color: #FFFFFF; font-family: 'Montserrat', sans-serif; font-size:16px;">Twallace@wallysconveniencestore.com</span>
                    </button>

                    <button type="button"
                        class="list-group-item d-flex align-items-center justify-content-between contact"
                        onclick="window.open('http://www.wallysconveniencestore.com/', '_blank')">
                        <img src="Images/icon/internet.png" alt=""
                            style="width: 30px; height: 30px; margin-right:25px;">
                        <span class="text-center flex-grow-1 text-truncate custom-phone"
                            style="color: #FFFFFF; 'Montserrat', sans-serif; font-size:16px; font-size:16px;">www.wallysconveniencestore.com</span>
                    </button>
