    ...
    <div class="d-flex justify-content-center mt-5">
        <div class="card custom-card shadow-lg" style="background-color:rgb(0, 0, 0);">
            <div class="card-header custom-header text-center"
                style="background-image: url('banner_img/client_banner/donsherman-b.jpg'); height: 260px; opacity: 1;">
            ...
            <div class="card-body text-center"
                ...
                <h2 class="card-title">Amy Wijesiri</h2>
                <p style="color:rgb(255, 255, 255); font-size: 15px; text-transform: uppercase;">Head of Operations</p>

                <a href="https://wa.me/+94766355355" target="_blank" rel="noopener noreferrer"
                ...
                <div class="list-group mb-3">
                    <div>
                        <button type="button"
                            ...
                            onclick="window.open('tel:+94766355355', '_self')">
                    ...
                    <div>
                        <button type="button"
                            class="list-group-item d-flex align-items-center justify-content-between contact w-100 rounded rounded-2"
                            onclick="window.open('mailto:amiwij@dshermanedu.onmicrosoft.com', '_self')">
                            <img src="Images/icon/mail.png" alt=""
                                style="width: 30px; height: 30px; margin-right:25px;">
                            <span class="text-center flex-grow-1 text-truncate custom-phone"
                                style="color: #edb928; font-family: 'Montserrat', sans-serif; font-size:16px;">amiwij@dshermanedu.onmicrosoft.com</span>
                        </button>
                    </div>
