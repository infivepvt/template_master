        ...
        <div class="card custom-card shadow-lg" style="background-color: #FFFFFF;">
            ...
            -->
                <div class="profile-picture">
                    <img src="profile_img/client_profile/srimal-p.png" alt="Bundala Safari with Srimal"
            ...
            <div class="card-body text-center"
                ...
                <h2 class="card-title" style="font-size: 27px; text-transform: uppercase;">Bundala Safari with Srimal
                </h2>
                ...
                <div class="list-group mb-3">
                    ...
                    <button type="button"
                        ...
                        <span class="text-center flex-grow-1 text-truncate custom-phone"
                            style="color: #FFFFFF; font-family: 'Montserrat', sans-serif; font-size:16px;">No.01,
                            Tissamaharama Road, Weligatta,<br> Hambantota 82004</span>
                    </button>
                </div>
                ...
                <div class="d-flex flex-wrap justify-content-center">
                    <a href="https://www.facebook.com/share/16KFEMvtFP/?mibextid=wwXIfr" target="_blank"
                        rel="noopener noreferrer" class="m-3">
                        <img src="Images/Social_Media_Icon/facebook.png" alt="" style="width: 40px; height: 50px;">
                    </a>
                    <a href="https://www.instagram.com/bundala_safari_srimal_srilanka?igsh=OGttanBteDc3ZHBs&utm_source=qr"
                    ...
                    <a href="https://www.tiktok.com/@srimalsafari0srilanka?_t=ZS-8wyFQbEy4hd&_r=1" target="_blank"
                        rel="noopener noreferrer" class="m-3">
                        <img src="Images/Social_Media_Icon/tiktok.png" alt="" style="width: 50px; height: 50px;">
                    </a>
                    <a href="https://youtu.be/X149wsyZB3I?si=4U9E62KmNh3wgzwK" target="_blank" rel="noopener noreferrer"
                        class="m-3">
                        <img src="Images/Social_Media_Icon/youtube.png" alt="" style="width: 50px; height: 50px;">
                    </a>
                    <a href="https://www.tripadvisor.co.uk/Attraction_Review-g1027209-d15843807-Reviews-Bundala_Safari_with_Srimal-Hambantota_Tangalle_Southern_Province.html"
                        target="_blank" rel="noopener noreferrer" class="m-3">
                ...
                <div class="gallery-container" id="galleryContainer">
                    <div class="gallery-item"
                        onclick="openLightbox('gallery_img/client_gallerys/srimal/srimal-g1.jpeg')">
                        <img src="gallery_img/client_gallerys/srimal/srimal-g1.jpeg" class="gallery-image">
                    </div>
                    <div class="gallery-item"
                        onclick="openLightbox('gallery_img/client_gallerys/srimal/srimal-g2.jpeg')">
                        <img src="gallery_img/client_gallerys/srimal/srimal-g2.jpeg" alt="Gallery Image 2"
                            class="gallery-image">
                    </div>
                    <div class="gallery-item"
                        onclick="openLightbox('gallery_img/client_gallerys/srimal/srimal-g3.jpeg')">
                        <img src="gallery_img/client_gallerys/srimal/srimal-g3.jpeg" alt="Gallery Image 3"
                            class="gallery-image">
                    </div>
                    <div class="gallery-item"
                        onclick="openLightbox('gallery_img/client_gallerys/srimal/srimal-g4.jpeg')">
                        <img src="gallery_img/client_gallerys/srimal/srimal-g4.jpeg" alt="Gallery Image 4"
                            class="gallery-image">
                    </div>
                    <div class="gallery-item"
                        onclick="openLightbox('gallery_img/client_gallerys/srimal/srimal-g5.jpeg')">
                        <img src="gallery_img/client_gallerys/srimal/srimal-g5.jpeg" alt="Gallery Image 5"
                            class="gallery-image">
                    </div>
                    <div class="gallery-item"
                        onclick="openLightbox('gallery_img/client_gallerys/srimal/srimal-g6.jpeg')">
                        <img src="gallery_img/client_gallerys/srimal/srimal-g6.jpeg" alt="Gallery Image 6"
                            class="gallery-image">
                    </div>
                </div>
