    ...
    <div class="d-flex justify-content-center mt-5">
        <div class="card custom-card shadow-lg" style="background-color: #FFFFFF;">
            <div class="card-header custom-header text-center"
                style="background-image:  url('banner_img/client_banner/shashika-b.jpg'); height: 200px; opacity: 1;">
                ...
                <div class="profile-picture">
                    <img src="profile_img/client_profile/shashika-p.png" alt="Saliya Pathum" class="rounded-circle">
                </div>
            </div>
            <br>
            <br>
            <div class="card-body text-center"
                ...
                <h2 class="card-title" style="font-size: 27px; text-transform: uppercase;">SHASHIKA GAMAGE</h2>
                <p style="color: #000000; font-size: 21px; text-transform: uppercase;">Chief Sales Officer</p>

                <a href="https://wa.me/94777999207" target="_blank" rel="noopener noreferrer"
                ...
                <div class="list-group mb-3">
                    <button type="button"
                        ...
                        onclick="window.open('tel:0777999207', '_self')">
                        <img src="Images/icon/phone.png" alt="" style="width: 30px; height: 30px; margin-right:25px;">
                        <span class="text-center flex-grow-1 text-truncate custom-phone"
                            style="color: #FFFFFF; font-family: 'Montserrat', sans-serif;">0777999207</span>
                    </button>

                    <button type="button"
                        class="list-group-item d-flex align-items-center justify-content-between contact"
                        onclick="window.open('mailto:shashikag@premiumautoparts.lk', '_self')">
                        <img src="Images/icon/mail.png" alt="" style="width: 30px; height: 30px; margin-right:25px;">
                        <span class="text-center flex-grow-1 text-truncate custom-phone"
                            style="color: #FFFFFF; font-family: 'Montserrat', sans-serif; font-size:16px;">shashikag@premiumautoparts.lk</span>
                    </button>

                    <button type="button"
                        class="list-group-item d-flex align-items-center justify-content-between contact"
                        onclick="window.open('http://www.premiumautoparts.lk/', '_blank')">
                        <img src="Images/icon/internet.png" alt=""
                            style="width: 30px; height: 30px; margin-right:25px;">
                        <span class="text-center flex-grow-1 text-truncate custom-phone"
                            style="color: #FFFFFF; 'Montserrat', sans-serif; font-size:16px; font-size:16px;">www.premiumautoparts.lk</span>
                    </button>

                    <button type="button"
                        class="list-group-item d-flex align-items-center justify-content-between contact"
                        onclick="window.open('https://www.google.com/maps/place/127+Wellawaya+Rd,+Monaragala/@6.871575,81.347635,17z/data=!3m1!4b1!4m5!3m4!1s0x3ae45071d7219a45:0xef2b98fb23c1a483!8m2!3d6.8715697!4d81.3502099?authuser=0&entry=ttu&g_ep=EgoyMDI1MDUxMS4wIKXMDSoASAFQAw%3D%3D', '_blank')">
                ...
                <div class="d-flex flex-wrap justify-content-center">
                    <a href="https://www.facebook.com/share/1BfGGGdP73/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" class="m-3">
                        <img src="Images/Social_Media_Icon/facebook.png" alt="" style="width: 50px; height: 50px;">
                    </a>
                    <a href="https://www.linkedin.com/company/premium-auto-parts/" target="_blank" rel="noopener noreferrer" class="m-3">
