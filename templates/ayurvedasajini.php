...
<body>
  ...
  <div class="name-section">
    <h4 style="color:#5b0e2e;font-weight :bold">Mrs.Sajini Weerakkody  </h4>
    <div class="divider"></div>
    <p class="text-muted">Reservation & Guest Relations Manager</p>
    <p class="small-text">
  ...
  <div class="container my-4">
    <div class="row text-center contact-box mx-1 justify-content-center">
      <div class="col-4 mb-3" onclick="window.open('tel:0704725634 ', '_self')">
        <i class="fas fa-mobile-alt contact-icon"></i><br />
        <span>Call 1</span>
      </div>
      <div class="col-4 mb-3" onclick="window.open('tel:0706428428 ', '_self')">
        <i class="fas fa-mobile-alt contact-icon"></i><br />
        <span>Call 2</span>
      </div>
      ...
      <div class="col-4 mb-3" onclick="window.open('https://wa.me/94706428428 ', '_blank')">
        <i class="fab fa-whatsapp contact-icon"></i><br />
        <span>Whatsapp</span>
      </div>
      <div class="col-4 mb-3" onclick="window.open('mailto:sajini@adhitya.lk', '_self')">
...
<div class="container my-4">
  ...
  <script>
    async function generateVCF() {
      // Updated contact information to match Mrs. Sajini Weerakkody's business card
      const contactData = {
        firstName: "Sajini",
        lastName: "Weerakkody",
        title: "Reservation & Guest Relations Manager",
        phoneWork: "0252030200",
        phoneMobile1: "0704725634",
        phoneMobile2: "0706428428",
        whatsapp: "94706428428",
        email: "sajini@adhitya.lk",
...
TEL;TYPE=CELL,VOICE:${contactData.phoneMobile1}
TEL;TYPE=CELL,VOICE:${contactData.phoneMobile2}
TEL;TYPE=CELL,WHATAPP:${contactData.whatsapp}
