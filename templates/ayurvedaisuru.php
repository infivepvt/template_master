...
<body>
  ...
  <div class="name-section">
    <h4 style="color:#5b0e2e;font-weight :bold">Mr.Isuru Dissanayaka</h4>
    <div class="divider"></div>
    <p class="text-muted">Purchasing Officer</p>
    <p class="small-text">
  ...
  <div class="container my-4">
    <div class="row text-center contact-box mx-1 justify-content-center">
      <div class="col-4 mb-3" onclick="window.open('tel:0719501866 ', '_self')">
        <i class="fas fa-mobile-alt contact-icon"></i><br />
        <span>Call</span>
      </div>
      <div class="col-4 mb-3" onclick="window.open('tel:0712083373', '_self')">
        <i class="fas fa-mobile-alt contact-icon"></i><br />
        <span>Call</span>
      </div>
      ...
      <div class="col-4 mb-3" onclick="window.open('https://wa.me/94719501866 ', '_blank')">
...
async function generateVCF() {
  ...
  const contactData = {
    ...
    phoneMobile1: "+94719501866",
    phoneMobile2: "+94712083373",
    phoneOffice: "+94252030200",
