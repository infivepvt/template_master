...
<body>
    <div class="d-flex justify-content-center mt-5">
        <div class="card custom-card shadow-lg" style="background-color:rgb(255, 255, 255);">
            ...
            <div class="card-body text-center"
                ...
                <h2 class="card-title" style="font-size: 24px; text-transform: uppercase; margin-top:-20px">Hotel Sudu Araliya</h2>
                ...
                <div class="list-group mb-3">
                    <button type="button"
                        ...
                        <span class="text-center flex-grow-1 text-truncate custom-phone"
                            style="color: #FFFFFF; font-family: 'Montserrat', sans-serif; font-size:16px">+94 272 224 849</span>
                    </button>
                    ...
                    <button type="button"
                        ...
                        <span class="text-center flex-grow-1 text-truncate custom-phone"
                            style="color: #FFFFFF; font-family: 'Montserrat', sans-serif; font-size:15px;">Hotel Sudu Araliya, New town, <br>Polonnaruwa, Sri Lanka</span>
                    </button>
                </div>

                <p class="fw" style="font-family: 'Montserrat', sans-serif; font-size:15px; margin-top:-10px;">REVIEW US</p>
                <div style="margin-top:-20px;">
                    <a href="https://g.page/r/CQOzseQtowpfEAI/review" target="_blank" rel="noopener noreferrer" class="m-3" style="text-decoration:none">
                            <img src="Images/icon/google.png"  style="width: 45px; height: 45px;">
                    </a>
                    <a href="https://www.tripadvisor.com/UserReviewEdit-g304140-d577158-Hotel_Sudu_Araliya-Polonnaruwa_North_Central_Province.html" target="_blank" rel="noopener noreferrer" class="m-3" style="text-decoration:none">
                            <img src="Images/icon/tripadvisor.png" alt="" style="width: 100px; height: 35px;margin-top:10px">
                    </a>
                    <a href="https://www.booking.com/hotel/lk/sudu-araliya.en-gb.html?label=gen173nr-1BCAsohQFCDHN1ZHUtYXJhbGl5YUgzWARohQGIAQGYAQm4ARjIAQzYAQHoAQGIAgGoAgS4AuufnMEGwAIB0gIkMDI5MmRmMDYtMTJjNC00YTZhLWE4NDktOTNlZWYwYmZlYTA52AIF4AIB&sid=55a24909d80faec8a736372abde41678&dist=0&group_adults=2&group_children=0&keep_landing=1&no_rooms=1&sb_price_type=total&type=total&" target="_blank" rel="noopener noreferrer" class="m-3" style="text-decoration:none">
    ...
    function generateVCF() {
        ...
        const contactData = {
            ...
            email2: "",
            email3: "",
            website: "https://www.hotelsuduaraliya.com", // Added https://
            website2: "",
            website3: "",
            ...
            about: "",
            logo: "",
            // Using full absolute URL for the profile image
...
PHOTO;TYPE=JPEG;ENCODING=b;VALUE=URI:${contactData.profileImage}
