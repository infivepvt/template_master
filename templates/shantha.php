    ...
    <div class="d-flex justify-content-center mt-5">
        <div class="card custom-card75 shadow-lg" style="background-color: #00114b;">
            <div class="card-header custom-header text-center"
                style="background-image: url('banner_img/client_banner/shantha-b.jpeg'); height: 200px; opacity: 1;">
                ...
                <div class="profile-picture75">
                    <img src="profile_img/client_profile/shantha-p.png" alt="Peter Smith" class="rounded-circle">
                </div>
            </div>
            <br><br>
            ...
            <div class="card-body text-left" style="background-color: #00114b; color: #000000;">
                <h2 class="card-title" style="font-size: 30px;color:rgb(255, 255, 255);">Shantha Mahanama</h2>
                <p style="color:rgb(255, 255, 255); font-size: 20px;">National Tourist Guide Lecturer <br>(Italian
                    Language)</p>
                <a href="https://wa.me/94777398842" target="_blank" rel="noopener noreferrer"
                ...
                <div class="list-group mb-3">
                    <button type="button"
                        ...
                        onclick="window.open('tel:+94777398842', '_self')">
                        <img src="Images/icon/phone.png" alt="" style="width: 30px; height: 30px; margin-right:25px;">
                        <span class="text-center flex-grow-1 text-truncate custom-phone"
                            style="color: #FFFFFF; font-family: 'Montserrat', sans-serif;">+94 77 739 8842</span>
                    </button>
                    <button type="button"
                        class="list-group-item d-flex align-items-center justify-content-between contact"
                        onclick="window.open('tel:+94112792747', '_self')">
                        <img src="Images/icon/landphone.png" alt=""
                            style="width: 30px; height: 30px; margin-right:25px;">
                        <span class="text-center flex-grow-1 text-truncate custom-phone"
                            style="color: #FFFFFF; font-family: 'Montserrat', sans-serif;">+94 11 279 2747</span>
                    </button>
                    <button type="button"
                        class="list-group-item d-flex align-items-center justify-content-between contact"
                        onclick="window.open('tel:+94112795260', '_self')">
                        <img src="Images/icon/landphone.png" alt=""
                            style="width: 30px; height: 30px; margin-right:25px;">
                        <span class="text-center flex-grow-1 text-truncate custom-phone"
                            style="color: #FFFFFF; font-family: 'Montserrat', sans-serif;">+94 11 279 5260</span>
                    </button>

                    <button type="button"
                        class="list-group-item d-flex align-items-center justify-content-between contact"
                        onclick="window.open('mailto:shanthak898@gmail.com', '_self')">
                        <img src="Images/icon/mail.png" alt="" style="width: 30px; height: 30px; margin-right:25px;">
                        <span class="text-center flex-grow-1 text-truncate custom-phone"
                            style="color: #FFFFFF; font-family: 'Montserrat', sans-serif; font-size:16px;">shanthak898@gmail.com</span>
                    </button>
                    ...
                    <button type="button"
                        class="list-group-item d-flex align-items-center justify-content-between contact"
                        onclick="window.open('https://www.google.com/maps?q=6.923215866088867,79.91081237792969&z=17&hl=en', '_blank')">
                        <img src="Images/icon/map.png" alt="" style="width: 30px; height: 30px; margin-right:25px;">
                        <span class="text-center flex-grow-1 text-truncate custom-phone"
                            style="color: #FFFFFF; font-family: 'Montserrat', sans-serif; font-size:16px;">898/2c,
                            Thalagaha Junction New Town, Gothatuwa.</span>
                    </button>
                </div>
    ...
    <script>
        ...
        document.getElementById('saveContactBtn').addEventListener('click', async function () {
            try {
                ...
                profileImage.src = 'profile_img/client_profile/shantha-p.png';
...
VERSION:3.0
FN:Shantha Mahanama
TITLE:National Tourist Guide Lecturer (Italian Language)
TEL;TYPE=CELL,VOICE:+94777398842
TEL;TYPE=WORK,VOICE:+94112792747
TEL;TYPE=WORK,VOICE:+94112795260
EMAIL:shanthak898@gmail.com
ADR;TYPE=WORK:;;898/2c, Thalagaha Junction New Town, Gothatuwa
...
END:VCARD`;
                ...
                link.href = url;
                link.download = 'Shantha Mahanama.vcf';
