...
.website-button {
    ...
    width: 100%;
    max-width: 350px;
    background: linear-gradient(135deg, #1e3a8a, #3b82f6); /* Blue gradient for a professional look */
    box-shadow: 0 4px 10px rgba(0, 0, 0, 0.2);
    border: 1px solid #ffffff20; /* Subtle white border */
}

.website-button:hover {
    background: linear-gradient(135deg, #2563eb, #60a5fa); /* Lighter gradient on hover */
...
.website-button .text-wrapper {
    margin-left: 12px;
}

.website-button .platform-name {
    font-weight: bold;
    color: #fff;
    font-size: 16px;
    font-family: 'Montserrat', sans-serif;
...
<body>
  ...
  <div class="profile-card">
    ...
    <div class="social-media-links-column">
      ...
      <a href="https://www.tuneandtransit.com/" class="social-media-button website-button">
        <img src="Images/Social_Media_Icon/website.png" alt="Website Icon" style="width: 40px; height: 40px;">
        <div class="text-wrapper">
          <span class="platform-name">Tune & Transit</span>
