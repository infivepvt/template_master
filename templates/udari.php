        ...
        <div class="card custom-card shadow-lg" style="background-color: #FFFFFF;">
            <div class="card-header custom-header text-center"
                ...
                <div class="profile-picture">
                    <img src="profile_img/client_profile/udari-gamage-p.jpeg" alt="Saliya Pathum" class="rounded-circle" style="scale:1.2 ;">
                </div>
            </div>
            <br>
            <br>
            <div class="card-body text-center"
                ...
                <h2 class="card-title" style="font-size: 27px; text-transform: uppercase;">UDARI GAMAGE</h2>
                <p style="color: #000000; font-size: 21px; text-transform: uppercase;">Digital Media Consultant</p>
                ...
                <div class="d-flex flex-wrap justify-content-center" style="margin-top: -10px;">
                    ...
                    <a href="https://www.facebook.com/udari.lakmini.904?rdid=NxXskXJy3cO3mUfT&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1A8UwjwguD%2F#" target="_blank" rel="noopener noreferrer" class="m-3">
                        <img src="Images/Social_Media_Icon/facebook.png" alt="" style="width: 50px; height: 50px;">
                    </a>
                    <a href="https://www.linkedin.com/in/udari-gamage-834a68291/" target="_blank" rel="noopener noreferrer" class="m-3">
                        <img src="Images/Social_Media_Icon/linkedin.png" alt="" style="width: 50px; height: 50px;">
                    </a>
                    <a href="https://www.tiktok.com/@udari.gamage98?_t=ZS-8wkgcEihIht&_r=1" target="_blank" rel="noopener noreferrer" class="m-3">
                ...
                <a href="https://wa.me/94716979414" target="_blank" rel="noopener noreferrer"
                ...
                <div class="list-group mb-3">
                    <button type="button"
                        ...
                        onclick="window.open('tel:0716979414', '_self')">
                        <img src="Images/icon/phone.png" alt="" style="width: 30px; height: 30px;">
                        <span class=" flex-grow-1 text-truncate custom-phone"
                            style="color: #FFFFFF; font-family: 'Montserrat', sans-serif;">0716979414</span>
                    </button>

                    <button type="button"
                        class="gradient-button list-group-item d-flex align-items-center justify-content-between contact"
                        onclick="window.open('mailto:udarigamage21@gmail.com ', '_self')">
                        <img src="Images/icon/mail.png" alt="" style="width: 30px; height: 30px;">
                        <span class=" flex-grow-1 text-truncate custom-phone"
                            style="color: #FFFFFF; font-family: 'Montserrat', sans-serif; font-size:16px;">udarigamage21@gmail.com </span>
                    </button>
                ...
                <div class="row">
                    <blockquote class="tiktok-embed" cite="https://www.tiktok.com/@udari.gamage98/video/7503872172578901266" data-video-id="7503872172578901266" style="max-width: 605px;min-width: 325px;">
                        <section> <a target="_blank" title="@udari.gamage98" href="https://www.tiktok.com/@udari.gamage98?refer=embed">@udari.gamage98</a> 😁❤️ <a title="girl" target="_blank" href="https://www.tiktok.com/tag/girl?refer=embed">#girl</a> <a title="vibes" target="_blank" href="https://www.tiktok.com/tag/vibes?refer=embed">#vibes</a> <a title="fyp" target="_blank" href="https://www.tiktok.com/tag/fyp?refer=embed">#fyp</a> <a title="foryou" target="_blank" href="https://www.tiktok.com/tag/foryou?refer=embed">#foryou</a> <a title="fy" target="_blank" href="https://www.tiktok.com/tag/fy?refer=embed">#fy</a> <a title="contentcreator" target="_blank" href="https://www.tiktok.com/tag/contentcreator?refer=embed">#contentcreator</a> <a target="_blank" title="♬ original sound - Udari Lakmini" href="https://www.tiktok.com/music/original-sound-7503872208486320912?refer=embed">♬ original sound - Udari Lakmini</a> </section>
                    </blockquote>
    ...
    <script>
        ...
        async function generateVCF() {
            const contactData = {
                ...
                phoneWork: "+94716979414",
                phoneMobile: "",
                email: "udarigamage21@gmail.com",
                email2: "",
                email3: "",
                website: "",
                website2: "",
                ...
                address2: "",
                about: "",
                logo: "https://tapilinq.com/profile_img/client_profile/udari-gamage-p.jpeg",
                profileImage: "https://tapilinq.com/profile_img/client_profile/udari-gamage-p.jpeg" // Same as logo in this case
            };
