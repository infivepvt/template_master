    ...
    <div class="d-flex justify-content-center mt-5">
        <div class="card custom-card75 shadow-lg" style="background-color: #00114b;">
            <div class="card-header custom-header text-center"
                style="background-image: url('banner_img/client_banner/buddhi-b.jpg'); height: 100%; opacity: 1;">
            ...
            <div class="card-body text-left" style="background-color: #00114b; color: #000000;">
                <h2 class="card-title" style="font-size: 30px;color:rgb(255, 255, 255);">Buddhi Chandrasena</h2>
                <p style="color:rgb(255, 255, 255); font-size: 20px;">Chief of Staff</p>
                <a href="https://wa.me/94777035392" target="_blank" rel="noopener noreferrer"
                ...
                <div class="list-group mb-3">
                    <button type="button"
                        ...
                        onclick="window.open('tel:0777035392', '_self')">
                        <img src="Images/icon/phone.png" alt="" style="width: 30px; height: 30px; margin-right:25px;">
                        <span class="text-center flex-grow-1 text-truncate custom-phone"
                            style="color: #FFFFFF; font-family: 'Montserrat', sans-serif;">0777035392</span>
                    </button>

                    <button type="button"
                        class="list-group-item d-flex align-items-center justify-content-between contact"
                        onclick="window.open('mailto:buddhic@inqube.com', '_self')">
                        <img src="Images/icon/mail.png" alt="" style="width: 30px; height: 30px; margin-right:25px;">
                        <span class="text-center flex-grow-1 text-truncate custom-phone"
                            style="color: #FFFFFF; font-family: 'Montserrat', sans-serif; font-size:16px;">buddhic@inqube.com</span>
                    </button>

                    <button type="button"
                        class="list-group-item d-flex align-items-center justify-content-between contact"
                        onclick="window.open('https://www.inqubeglobal.com', '_blank')">
                        <img src="Images/icon/internet.png" alt=""
                            style="width: 30px; height: 30px; margin-right:25px;">
                        <span class="text-center flex-grow-1 text-truncate custom-phone"
                            style="color: #FFFFFF; font-family: 'Montserrat', sans-serif; font-size:16px; font-size:16px;">www.inqubeglobal.com</span>
                    </button>

                    <button type="button"
                        class="list-group-item d-flex align-items-center justify-content-between contact"
                        onclick="window.open('https://maps.app.goo.gl/bWVAiuqb1Q45QBTZ8', '_blank')">
                        <img src="Images/icon/map.png" alt="" style="width: 30px; height: 30px; margin-right:25px;">
                        <span class="text-center flex-grow-1 text-truncate custom-phone"
                            style="color: #FFFFFF; font-family: 'Montserrat', sans-serif; font-size:16px;">InQube Global (Pvt) Ltd
                            606B, Siri Sumanathissa Mawatha, Nawagamuwa South, Ranala,
                            Sri Lanka</span>
                    </button>
                </div>
                ...
                <div class="d-flex flex-wrap justify-content-center">
                    <a href="https://www.linkedin.com/in/buddhi-chandrasena-2aa1b230?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer" class="m-3">
    ...
    <script>
        ...
        document.getElementById('saveContactBtn').addEventListener('click', async function() {
            const contactData = {
                ...
                phoneWork: "+94777035392",
                phoneMobile: "+94777035392",
                email: "buddhic@inqube.com",
                email2: "",
                email3: "",
                website: "www.inqubeglobal.com",
                website2: "",
                website3: "",
                address: "",
                address2: "",
