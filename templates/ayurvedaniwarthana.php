...
<body>
  ...
  <div class="name-section">
    <h4 style="color:#5b0e2e;font-weight :bold">Ms.Niwarthana Bandara</h4>
    <div class="divider"></div>
    <p class="text-muted">Accounts Executive</p>
    <p class="small-text">
  ...
  <div class="container my-4">
    <div class="row text-center contact-box mx-1 justify-content-center">
      <div class="col-4 mb-3" onclick="window.open('tel:0716317480 ', '_self')">
      ...
      <div class="col-4 mb-3" onclick="window.open('https://wa.me/94716317480 ', '_blank')">
        <i class="fab fa-whatsapp contact-icon"></i><br />
        <span>Whatsapp</span>
      </div>
      <div class="col-4 mb-3" onclick="window.open('mailto:niwarthanaadhitya26@gmail.com', '_self')">
...
async function generateVCF() {
  ...
  const contactData = {
    firstName: "Niwarthana",
    lastName: "Bandara",
    title: "Accounts Executive",
    phoneMobile: "0716317480",
    phoneWork: "0252030200",
    email: "niwarthanaadhitya26@gmail.com",
  ...
  try {
    ...
    const base64Logo = logoCanvas.toDataURL('image/jpeg').split(',')[1];
