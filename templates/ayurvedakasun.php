...
<body>
  ...
  <div class="name-section">
    <h4 style="color:#5b0e2e;font-weight :bold">Dr.Kasun Sri Gunawardhana </h4>
  ...
  <div class="container my-4">
    <div class="row text-center contact-box mx-1 justify-content-center">
      <div class="col-4 mb-3" onclick="window.open('tel:0718108107 ', '_self')">
      ...
      <div class="col-4 mb-3" onclick="window.open('https://wa.me/94718108107', '_blank')">
        <i class="fab fa-whatsapp contact-icon"></i><br />
        <span>Whatsapp</span>
      </div>
      <div class="col-4 mb-3" onclick="window.open('mailto:drkasungunawardhana@gmail.com', '_self')">
        <i class="fas fa-envelope contact-icon"></i><br />
        <span>E-mail 1</span>
      </div>
      <div class="col-4 mb-3" onclick="window.open('mailto:kasun@adhitya.lk', '_self')">
        <i class="fas fa-envelope contact-icon"></i><br />
        <span>E-mail 2</span>
      </div>
  ...
  <script>
    async function generateVCF() {
      ...
      const contactData = {
        ...
        phoneMobile: "0718108107",
        email: "drkasungunawardhana@gmail.com",
        email2: "kasun@adhitya.lk",
...
VERSION:3.0
FN:Dr. ${contactData.firstName} ${contactData.lastName}
N:${contactData.lastName};${contactData.firstName};Dr.;;
...
END:VCARD`;
        ...
        a.href = url;
        a.download = `Dr_${contactData.firstName}_${contactData.lastName}.vcf`;
