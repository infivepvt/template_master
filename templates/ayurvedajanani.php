...
<body>
  ...
  <div class="name-section">
    <h4 style="color:#5b0e2e;font-weight :bold">Mrs.Janani Maduwanthi</h4>
    <div class="divider"></div>
    <p class="text-muted">Senior Coordinator</p>
    <p class="small-text">
  ...
  <div class="container my-4">
    <div class="row text-center contact-box mx-1 justify-content-center">
      <div class="col-4 mb-3" onclick="window.open('tel:0701755761', '_self')">
      ...
      <div class="col-4 mb-3" onclick="window.open('https://wa.me/94701755761', '_blank')">
        <i class="fab fa-whatsapp contact-icon"></i><br />
        <span>Whatsapp</span>
      </div>
      <div class="col-4 mb-3" onclick="window.open('mailto:Janani@adhitya.lk', '_self')">
  ...
  <div class="container my-4">
    ...
    <div class="d-flex flex-column align-items-center mb-4">
      ...
      <div class="d-flex justify-content-center">
        <a href="https://www.facebook.com/p/Adhitya-Ayurveda-Colombo-100093612950529" target="_blank"
          rel="noopener noreferrer" class="m-2">
          <img src="Images/Social_Media_Icon/facebook.png" alt="Facebook" style="width: 50px; height: 50px;">
        </a>
        <a href="https://lk.linkedin.com/company/adhitya-ayurveda-colombo" target="_blank" rel="noopener noreferrer"
          class="m-2">
          <img src="Images/Social_Media_Icon/linkedin.png" alt="LinkedIn" style="width: 50px; height: 50px;">
        </a>
        <a href="https://www.instagram.com/adhitya_ayurveda_colombo/" target="_blank" rel="noopener noreferrer"
          class="m-2">
    ...
    <div class="d-flex flex-column align-items-center mb-4">
      <p class="m-3" style="font-family: 'Rye', serif; font-size: 18px; color: #b9904e;text-align: center;">Adhitya Ayurveda | Anuradhapura
      </p>
      <div class="d-flex justify-content-center">
        <a href="https://www.facebook.com/adhitya.lk/" target="_blank" rel="noopener noreferrer" class="m-2">
          <img src="Images/Social_Media_Icon/facebook.png" alt="Facebook" style="width: 50px; height: 50px;">
        </a>
        <a href="https://lk.linkedin.com/company/gunawardhana-ayurveda-holdings-pvt-ltd" target="_blank"
          rel="noopener noreferrer" class="m-2">
          <img src="Images/Social_Media_Icon/linkedin.png" alt="LinkedIn" style="width: 50px; height: 50px;">
        </a>
    ...
    <div class="d-flex flex-column align-items-center mb-4">
      ...
      <div class="d-flex justify-content-center">
        ...
        <a href="https://www.linkedin.com/company/m%C3%A5ngata-galle" target="_blank" rel="noopener noreferrer"
          class="m-2">
          <img src="Images/Social_Media_Icon/linkedin.png" alt="LinkedIn" style="width: 50px; height: 50px;">
        </a>
  ...
  <script>
    async function generateVCF() {
      // Corrected contact information to match the business card
      const contactData = {
        firstName: "Janani",
        lastName: "Maduwanthi",
        title: "Senior Coordinator",
        phoneMobile: "+94701755761", // Standardized with country code
        phoneWork: "+94252030200",   // Standardized with country code
        email1: "ranuka@adhitya.lk",
        email2: "Janani@adhitya.lk",
        address: "No.395/4, Harischandra Mawatha;Anuradhapura;;;Sri Lanka", // VCF-compliant address format
        about: "Adhitya Ayurveda",
        website1: "https://www.adhityaayurveda.com/",
        ...
        logoUrl: "logo_img/client_logo/adhityaayurveda-l1.png"
      };
      ...
      try {
        ...
        logoImage.src = contactData.logoUrl;
        ...
        await Promise.all([
          new Promise((resolve) => {
            ...
            profileImage.onerror = () => {
              console.warn("Profile image failed to load, proceeding without it.");
              resolve();
            };
          }),
          new Promise((resolve) => {
            ...
            logoImage.onerror = () => {
              console.warn("Logo image failed to load, proceeding without it.");
              resolve();
            };
          })
        ]);
        ...
        if (profileImage.complete && !profileImage.onerror) {
          const canvas = document.createElement('canvas');
          const ctx = canvas.getContext('2d');
          canvas.width = profileImage.naturalWidth;
          canvas.height = profileImage.naturalHeight;
          ctx.drawImage(profileImage, 0, 0);
          base64ProfileImage = canvas.toDataURL('image/jpeg').split(',')[1];
        }

        // Convert logo image to base64
        let base64LogoImage = "";
        if (logoImage.complete && !logoImage.onerror) {
          const canvas = document.createElement('canvas');
          const ctx = canvas.getContext('2d');
          canvas.width = logoImage.naturalWidth;
          canvas.height = logoImage.naturalHeight;
          ctx.drawImage(logoImage, 0, 0);
          base64LogoImage = canvas.toDataURL('image/jpeg').split(',')[1];
        }
...
EMAIL;TYPE=WORK:${contactData.email1}
EMAIL;TYPE=WORK:${contactData.email2}
ADR;TYPE=WORK:;;${contactData.address}
URL;TYPE=WEBSITE1:${contactData.website1}
URL;TYPE=WEBSITE2:${contactData.website2}
URL;TYPE=WEBSITE3:${contactData.website3}
NOTE:${contactData.about}
${base64ProfileImage ? `PHOTO;ENCODING=b;TYPE=JPEG:${base64ProfileImage}` : ""}
${base64LogoImage ? `LOGO;ENCODING=b;TYPE=JPEG:${base64LogoImage}` : ""}
END:VCARD`;
        ...
        // Fallback to simple VCF without images
