...
<body>
  ...
  <div class="container my-4">
    <div class="row text-center contact-box mx-1 justify-content-center">
      <div class="col-4 mb-3" onclick="window.open('tel:0773939331', '_self')">
        <i class="fas fa-mobile-alt contact-icon"></i><br />
        <span>Call 1</span>
      </div>
      <div class="col-4 mb-3" onclick="window.open('tel:0704725630', '_self')">
        <i class="fas fa-mobile-alt contact-icon"></i><br />
        <span>Call 2</span>
      </div>
      ...
      <div class="col-4 mb-3" onclick="window.open('https://wa.me/94704725630', '_blank')">
        <i class="fab fa-whatsapp contact-icon"></i><br />
        <span>Whatsapp</span>
      </div>
      <div class="col-4 mb-3" onclick="window.open('mailto:ranuka@adhitya.lk', '_self')">
        <i class="fas fa-envelope contact-icon"></i><br />
        <span>E-mail 1</span>
      </div>
      <div class="col-4 mb-3" onclick="window.open('ranukask@gmail.com', '_self')">
        <i class="fas fa-envelope contact-icon"></i><br />
        <span>E-mail 2</span>
      </div>
...
async function generateVCF() {
  ...
  const contactData = {
    ...
    phoneMobile1: "0773939331",
    phoneMobile2: "0704725630",
    phoneWork: "0252030200",
    email1: "ranuka@adhitya.lk",
    email2: "ranukask@gmail.com",
