...
<body>
  ...
  <div class="name-section">
    <h4 style="color:#5b0e2e;font-weight :bold">Mrs.Danushika Rathnayake</h4>
  ...
  <div class="container my-4">
    <div class="row text-center contact-box mx-1 justify-content-center">
      ...
      <div class="col-4 mb-3" onclick="window.open('mailto:danushikaadhitya21@gmail.com', '_self')">
...
<div class="container my-4">
 ...
 <script>
  ...
  // Updated contact information for Mrs. Danushika Rathnayake
  const contactData = {
    firstName: "Danushika",
    lastName: "Rathnayake",
    ...
    email: "danushikaadhitya21@gmail.com",
