...
<body>
  ...
  <div class="name-section">
    <h4 style="color:#5b0e2e;font-weight :bold">Mr.Malinda Aberathne</h4>
    <div class="divider"></div>
    <p class="text-muted">Senior Executive - Purchasing
    </p>
    <p class="small-text">
  ...
  <div class="container my-4">
    <div class="row text-center contact-box mx-1 justify-content-center">
      <div class="col-4 mb-3" onclick="window.open('tel:0704727874 ', '_self')">
        <i class="fas fa-mobile-alt contact-icon"></i><br />
        <span>Call 1</span>
      </div>
      <div class="col-4 mb-3" onclick="window.open('tel:0766982910 ', '_self')">
        <i class="fas fa-mobile-alt contact-icon"></i><br />
        <span>Call 2</span>
      </div>
      ...
      <div class="col-4 mb-3" onclick="window.open('https://wa.me/94766982910 ', '_blank')">
        <i class="fab fa-whatsapp contact-icon"></i><br />
        <span>Whatsapp</span>
      </div>
      <div class="col-4 mb-3" onclick="window.open('mailto:malinda@adhitya.lk', '_self')">
  ...
  <script>
    async function generateVCF() {
      ...
      const contactData = {
        firstName: "Malinda",
        lastName: "Aberathne",
        title: "Senior Executive - Purchasing",
        phoneMobile1: "0704727874",
        phoneMobile2: "0766982910",
        phoneWork: "0252030200",
        email: "malinda@adhitya.lk",
...
END:VCARD`;
        ...
        // Fallback to simple VCF without image
