    ...
    <div class="d-flex justify-content-center mt-5 template-73">
        <div class="card custom-card73 shadow-lg" style="background-color:rgb(255, 255, 255);">
            <div class="card-header custom-header73 text-center"
                style="background-image: url('#'); height: 100%; opacity: 1; border-bottom-width: 1px; border-bottom-right-radius: 90%; border-bottom-left-radius: 0%;background-color: #183051;">
                <!-- <p style="color: #000000; font-size: 25px; font-weight:bold;">Belgo Bekart Aremes</p> -->
                <!-- <h2 class="card-title" style="font-size: 30px;color:rgb(255, 255, 255); ">Pamela C. Sullivan</h2>
                <h4 class="card-title" style="font-size: 12px;color:rgb(255, 255, 255); ">(MD. MBA. CPE. FACP. FCUCM. PT)</h4>
                ...
                <div class="profile-picture">
                    <img src="profile_img/client_profile/pamela-p.png" alt="Saliya Pathum" class="rounded-circle">
                </div>
            </div>
            <br>
            <br>
            <div class="card-body text-center" style="background-color:rgb(255, 255, 255); color: #000000;">
                <h2 class="card-title" style="font-size: 30px;color:rgb(0, 0, 0); ">Pamela C. Sullivan</h2>
                <h4 class="card-title" style="font-size: 12px;color:rgb(0, 0, 0); ">(MD. MBA. CPE. FACP. FCUCM. PT)</h4>
                <p style="color: #000000; font-size: 20px;">Founder</p>
                ...
                <div class="row">
                    <div class="contact-item col ">
                        <div class="border border-0  rounded rounded-2 p-2" style="background-color: #0d9b49;">
                            <a href="tel:585.738.3781" class="icon d-flex flex-column align-items-center justify-content-center"
                     ...
                     <div class="contact-item col ">
                        <div class="border border-0 rounded rounded-2 p-2" style="background-color: #0d9b49;">
                            <a href="mailto:drsullivan@nationalhealthcaresolutionspllc.com" class="icon d-flex flex-column align-items-center justify-content-center"
                                style="text-decoration: none;">
                    ...
                    <div class="contact-item col ">
                        <div class="border border-0  rounded rounded-2 p-2" style="background-color: #0d9b49;">
                            <a href="nationalhealthcaresolutionspllc.com" class="icon d-flex flex-column align-items-center justify-content-center"
                                style="text-decoration: none;">
               ...
               <div class="list-group mb-3">
                    ...
                    <!-- <button type="button"
                        ...
                        <i class="fab fa-facebook-f contact-icon me-3 mx-4" style="color: #183051;"></i>
                        <div>
                            <p class="icon-text mb-0 text-truncate">Facebook</p>
                            <p style="font-size:16px;color:rgb(122, 122, 122)">Facebook</p>
                        </div>
                    </button> -->
                    ...
                    <!-- <button type="button"
                        ...
                        class="list-group-item d-flex align-items-center justify-content-start contact" 
                        onclick="window.open('https://www.facebook.com', '_blank')">
                        <i class="fab fa-instagram contact-icon me-3 mx-4" style="color:#183051;"></i>
                        <div>
                            <p class="icon-text mb-0 text-truncate">Instagram</p>
                            <p style="font-size:16px;color:rgb(122, 122, 122)">Instagram</p>
                        </div>
                    </button> -->

                    <!-- Website -->
                    <button type="button"
                        style="padding:10px; border: 1px solid #183051;;"
                        class="list-group-item d-flex align-items-center justify-content-start contact" 
                        onclick="window.open('https://www.linkedin.com/in/pamcorisullivan?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app', '_blank')">
                        <i class="fab fa-linkedin-in contact-icon me-3 mx-4 fs-1" style="color: #183051;"></i>
                        <div class="d-flex flex-column align-items-start ">
                            <p class="icon-text mb-0 text-start mt-3" >Linkedin</p>
                            <p style="font-size:16px;color:rgb(122, 122, 122); margin-left:15px" class="text-start ">pamcorisullivan</p>
                        </div>
                    </button>
                    ...
                    <!-- Address -->
                     <!-- <button type="button"
                        ...
                        <div>
                            ...
                            <p style="font-size:16px;color:rgb(122, 122, 122)">Tiktok</p>
                        </div>
                    </button> -->
    ...
    <script>
        async function generateVCF() {
            const contactData = {
                ...
                email2: "",
                email3: "",
                website: "nationalhealthcaresolutionspllc.com",
                website2: "",
                website3: "",
                address: "",
                address2: "",
