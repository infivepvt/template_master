...
<body>
  ...
  <div class="name-section">
    <h4 style="color:#5b0e2e;font-weight :bold">Ms.Pubudini Karunathilaka  </h4>
  ...
  <div class="container my-4">
    <div class="row text-center contact-box mx-1 justify-content-center">
      <div class="col-4 mb-3" onclick="window.open('tel:0701755762 ', '_self')">
      ...
      <div class="col-4 mb-3" onclick="window.open('https://wa.me/94701755762 ', '_blank')">
        <i class="fab fa-whatsapp contact-icon"></i><br />
        <span>Whatsapp</span>
      </div>
      <div class="col-4 mb-3" onclick="window.open('mailto:pubudini@adhitya.lk', '_self')">
...
<div class="container my-4">
 ...
 <script>
  ...
  const contactData = {
    ...
    phoneMobile: "0701755762",
    phoneWork: "0252030200",
    email: "pubudini@adhitya.lk",
...
function generateSimpleVCF(contactData) {
  // Create VCF content without image
  let vcfContent = `BEGIN:VCARD
VERSION:3.0
N:${contactData.lastName};${contactData.firstName};;;
FN:${contactData.firstName} ${contactData.lastName}
