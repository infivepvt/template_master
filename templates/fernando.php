...
<body>
    <div class="profile-card">
        <div class="profile-banner">
            <div class="imagepro">
                <img class="profile-photo" src="profile_img/client_profile/fernando.jpg" alt="Profile">
            </div>
            <div class="profile-info">
                <h2 style="font-family: Verdana, sans-serif;">Sudath Fernando</h2>
                <p style="font-family: Roboto, sans-serif;">Life Coach and Sustainability Advocate</p>
            </div>
        </div>

        <div class="profile-contact-icons">
            <button class="icon-button" onclick="window.open('tel:0773284193', '_self')">
                <i class="fas fa-phone"></i>
            </button>
            <button class="icon-button" onclick="window.open('mailto:sudav1968@gmail.com', '_self')">
                <i class="fas fa-envelope"></i>
            </button>
            <button class="icon-button" onclick="window.open('https://sudathspeaks.lk/', '_blank')">
                <i class="fas fa-globe"></i>
            </button>
            <button class="icon-button" onclick="window.open('https://wa.me/94773284193', '_blank')">
                <i class="fab fa-whatsapp"></i>
            </button>
        </div>

        <div class="social-media-links-column">
            <a href="https://www.facebook.com/SudathSpeaks" class="social-media-button">
                <img src="Images/Social_Media_Icon/facebook.png" alt="" style="width: 40px; height: 40px;">
                <div class="text-wrapper">
                    <span class="platform-name">Facebook</span>
                    <br>
                    <span class="user-name">SudathSpeaks</span>
                </div>
            </a>
            <a href="https://www.instagram.com/sudathspeaks/?__pwa=1" class="social-media-button">
            ...
            <a href="https://www.tiktok.com/@sudathspeaks" class="social-media-button">
            ...
            <a href="https://www.youtube.com/@SudathFernando" class="social-media-button">
                <img src="Images/Social_Media_Icon/youtube.png" alt="" style="width: 40px; height: 40px;">
                <div class="text-wrapper">
                    <span class="platform-name">YouTube</span>
                    <br>
                    <span class="user-name">Sudath Fernando</span>
                </div>
            </a>
            <a href="https://www.linkedin.com/in/sudath-fernando-3a0b18a0/" class="social-media-button">
            ...
            <div class="gallery-section">
                ...
                <div class="gallery-container" id="galleryContainer">
                    ...
                    <div class="gallery-item" onclick="openLightbox('gallery_img/client_gallerys/fernando/fernando-g5.JPG')">
                        <img src="gallery_img/client_gallerys/fernando/fernando-g5.JPG" alt="Gallery Image 5" class="gallery-image">
                    </div>
                    <div class="gallery-item" onclick="openLightbox('gallery_img/client_gallerys/fernando/fernando-g6.png')">
                        <img src="gallery_img/client_gallerys/fernando/fernando-g6.png" alt="Gallery Image 6" class="gallery-image">
                    </div>
                </div>
            </div>

            <!-- Save to Contacts button moved here -->
    ...
    <script>
        ...
        async function downloadVCF() {
            const contactData = {
                firstName: "Sudath",
                lastName: "Fernando",
                title: "Life Coach and Sustainability Advocate",
                organization: "",
                phoneMobile: "+94773284193",
                email: "sudav1968@gmail.com",
                url: "https://sudathspeaks.lk/",
                address: "",
                note: "Hi. I am Sudath Fernando, working as a Life Coach and Sustainability Advocate.",
                profileImage: "profile_img/client_profile/fernando.jpg"
            };
            ...
            let vcfLines = [
                ...
                contactData.note ? `NOTE:${contactData.note}` : '',
