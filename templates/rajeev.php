...
<body>
  ...
  <div class="container my-4">
    <div class="row text-center contact-box mx-1">
      ...
      <div class="col-4" onclick="window.open('http://www.avenddra.com/', '_blank')">
        <i class="fas fa-globe contact-icon"></i><br />
        <span>Website</span>
      </div>
    </div>
  ...
  <div class="d-flex flex-wrap justify-content-center">
                    ...
                    <a href="https://www.facebook.com/profile.php?id=61576584659017" target="_blank" rel="noopener noreferrer" class="m-3">
