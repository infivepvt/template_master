...
<head>
    ...
    <title>Gallways Holiday Home</title>
    ...
    <div class="d-flex justify-content-center mt-5">
        <div class="card custom-card75 shadow-lg" style="background-color: #00114b;">
            <div class="card-header custom-header text-center"
                style="background-image: url('banner_img/client_banner/gallways-b.jpeg'); opacity: 1;">
                <div class="profile-picture75">
                    <img src="profile_img/client_profile/gallways-p.jpg" alt="Peter Smith" class="rounded-circle">
                </div>
            </div>
            <br><br>
           <button class="btn w-20 custom-save-button75" id="saveContactBtn" onclick="generateVCF()">
            ...
            <div class="card-body text-left" style="background-color: #00114b; color: #000000;">
                <h2 class="card-title" style="font-size: 30px;color:rgb(255, 255, 255);">Gallways Holiday Home</h2>
                <p style="color:rgb(255, 255, 255); font-size: 20px;">Proptier</p>
                <a href="https://wa.me/qr/ZM7YQKSB45RPI1" target="_blank" rel="noopener noreferrer"
                ...
                <div class="list-group mb-3">
                    ...
                    <button type="button"
    class="list-group-item d-flex align-items-center justify-content-between contact"
    onclick="window.open('https://g.co/kgs/6zEj63C', '_blank')">
    <img src="Images/icon/internet.png" alt=""
        style="width: 30px; height: 30px; margin-right:25px;">
    <span class="text-center flex-grow-1 text-truncate custom-phone"
        style="color: #FFFFFF; 'Montserrat', sans-serif; font-size:16px; font-size:16px;">www.gallwaysholidayhome.com</span>
</button>

<button type="button"
    class="list-group-item d-flex align-items-center justify-content-between contact"
    onclick="window.open('https://maps.app.goo.gl/r4JhV4rDTfYmT2R86', '_blank')">
    <img src="Images/icon/map.png" alt="" style="width: 30px; height: 30px; margin-right:25px;">
    <span class="text-center flex-grow-1 text-truncate custom-phone"
        style="color: #FFFFFF; font-family: 'Montserrat', sans-serif; font-size:16px;">No 29, Nuwara Eliya, Sri Lanka, 22200</span>
</button>
                ...
                <div class="d-flex flex-wrap justify-content-center">
                    <a href="https://www.instagram.com/galways_holiday_home?igsh=OTAxZ214YTF0b2V1&utm_source=qr" target="_blank" rel="noopener noreferrer" class="m-3">
                        <img src="Images/Social_Media_Icon/instagram.png" alt="" style="width: 50px; height: 50px;">
                    </a>
                    <a href="https://www.facebook.com/share/1AWbAkySJe/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" class="m-3">
                ...
                <div class="gallery-container" id="galleryContainer">
                    <div class="gallery-item" onclick="openLightbox('gallery_img/client_gallerys/gallways/gallways-g1.jpeg')">
                        <img src="gallery_img/client_gallerys/gallways/gallways-g1.jpeg" class="gallery-image">
                    </div>
                    <div class="gallery-item" onclick="openLightbox('gallery_img/client_gallerys/gallways/gallways-g2.jpeg')">
                        <img src="gallery_img/client_gallerys/gallways/gallways-g2.jpeg" alt="Gallery Image 2" class="gallery-image">
                    </div>
                    <div class="gallery-item" onclick="openLightbox('gallery_img/client_gallerys/gallways/gallways-g3.jpeg')">
                        <img src="gallery_img/client_gallerys/gallways/gallways-g3.jpeg" alt="Gallery Image 3" class="gallery-image">
                    </div>
                    <div class="gallery-item" onclick="openLightbox('gallery_img/client_gallerys/gallways/gallways-g4.jpeg')">
                        <img src="gallery_img/client_gallerys/gallways/gallways-g4.jpeg" alt="Gallery Image 4" class="gallery-image">
                    </div>
                    <div class="gallery-item" onclick="openLightbox('gallery_img/client_gall erys/gallways/gallways-g5.jpeg')">
                        <img src="gallery_img/client_gallerys/gallways/gallways-g5.jpeg" alt="Gallery Image 5" class="gallery-image">
                    </div>
                    <div class="gallery-item" onclick="openLightbox('gallery_img/client_gallerys/gallways/gallways-g6.jpeg')">
                        <img src="gallery_img/client_gallerys/gallways/gallways-g6.jpeg" alt="Gallery Image 6" class="gallery-image">
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        const galleryImages = [
            'gallery_img/client_gallerys/gallways/gallways-g1.jpeg',
            'gallery_img/client_gallerys/gallways/gallways-g2.jpeg',
            'gallery_img/client_gallerys/gallways/gallways-g3.jpeg',
            'gallery_img/client_gallerys/gallways/gallways-g4.jpeg',
            'gallery_img/client_gallerys/gallways/gallways-g5.jpeg',
            'gallery_img/client_gallerys/gallways/gallways-g6.jpeg',
        ];

        async function generateVCF() {
            const contactData = {
                firstName: "Gallways Holiday Home",
                lastName: "",
                title: "Proptier",
                phoneWork: "",
                ...
                website2: "",
                website3: "",
                address: "No 29, Nuwara Eliya, Sri Lanka, 22200",
                address2: "",
                about: "",
                logo: "https://tapilinq.com/profile_img/client_profile/gallways-p.jpg",
                profileImage: "https://tapilinq.com/profile_img/client_profile/gallways-p.jpg" // Same as logo in this case
            };
