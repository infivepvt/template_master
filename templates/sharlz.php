        ...
        <div class="card custom-card shadow-lg" style="background-color: #FFFFFF;">
            ...
            <div class="list-group mb-3">
                <button type="button" class="list-group-item d-flex align-items-center justify-content-between contact"
                    onclick="window.open('tel:+94 776 768 678', '_self')">
                    <img src="Images/icon/phone.png" alt="" style="width: 30px; height: 30px; margin-right:25px;">
                    <span class="text-center flex-grow-1 text-truncate custom-phone"
                        style="color: #FFFFFF; font-family: 'Montserrat', sans-serif;">+94 776 768 678</span>
                </button>
                ...
                <button type="button" class="list-group-item d-flex align-items-center justify-content-between contact"
                    onclick="window.open('https://maps.google.com/?cid=9306023312110863478', '_blank')">
            ...
            <div class="gallery-container">
                <img src="gallery_img/client_gallerys/sharlz/sharlz-g1.jpeg" alt="Gallery Image" class="gallery-image">
            </div>
            <br>
