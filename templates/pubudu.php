...
<head>
    ...
    <title>Digital Business Card - Pubudu Prasad Fernando</title>
...
<body>
    <div class="custom-card-wrapper">
        <div class="card custom-card">
            ...
            <div class="profile-picture-container">
                <img src="logo_img/client_logo/celebration-l.jpeg" alt="Pubudu Prasad Fernando">
            </div>

            <div class="profile-info">
                <p class="name">Pubudu Prasad Fernando</p>
                <br>
            ...
            <div class="quick-contact-icons">
                <a href="tel:+9477473338" class="quick-contact-item">
                    <span class="icon"><i class="fas fa-phone-alt fa-flip-horizontal"></i></span>
                    <span class="text">CALL</span>
                </a>
                <a href="https://wa.me/+9477473338" class="quick-contact-item">
            ...
            <div class="company-info">
                ...
                <p><strong>Office:</strong> 23 Kithulampitiya Road, Kalegana, Galle</p>
                ...
                <ul>
                    ...
                    <li>International Blue Sapphire Award – Internationally Recognized</li>
                </ul>
    ...
    <script>
        async function generateVCF() {
            const contactData = {
                firstName: "Pubudu Prasad",
                lastName: "Fernando",
                title: "Director",
                organization: "Celebration Wedding Cars & Tours Pvt Ltd",
                phoneMobile1: "+9477473338",
                email: "info@celebrationweddings.lk",
                website: "https://celebrationweddings.lk",
                address: "23 Kithulampitiya Road, Kalegana, Galle, Sri Lanka",
