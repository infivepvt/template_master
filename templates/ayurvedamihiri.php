...
<body>
  ...
  <div class="container my-4">
    <div class="row text-center contact-box mx-1 justify-content-center">
      <div class="col-4 mb-3" onclick="window.open('tel:0704725632', '_self')">
      ...
      <div class="col-4 mb-3" onclick="window.open('https://wa.me/94704725632', '_blank')">
        <i class="fab fa-whatsapp contact-icon"></i><br />
        <span>Whatsapp</span>
      </div>
      <div class="col-4 mb-3" onclick="window.open('mailto:mihirihr@adhitya.lk', '_self')">
...
<div class="container my-4">
  ...
  // Contact information matching the HTML
  const contactData = {
    firstName: "Mihiri",
    lastName: "Hemachandra",
    title: "Human Resources Manager",
    phoneMobile: "0704725632",
    phoneWork: "0252030200",
    email: "mihirihr@adhitya.lk",
    ...
    if (!profileImage.complete) {
      await new Promise((resolve, reject) => {
        ...
        profileImage.onerror = () => {
          console.warn("Failed to load profile image, generating VCF without photo.");
          resolve(); // Continue without rejecting to generate VCF without photo
        };
      });
    }
...
URL;TYPE=WORK:${contactData.website2}
URL;TYPE=WORK:${contactData.website3}
